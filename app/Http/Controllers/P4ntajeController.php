 ...
 */
class P4ntajeController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('p4ntaje.index', compact('puntajes'))
    ...
    {
        $puntaje = new Puntaje();
        return view('p4ntaje.create', compact('puntaje'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('p4ntajes.index')
    ...
    public function show($id)
    {
        ...
        return view('p4ntaje.show', compact('puntaje'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('p4ntaje.edit', compact('puntaje'));
    }
