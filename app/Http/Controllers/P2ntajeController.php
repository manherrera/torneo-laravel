 ...
 */
class P2ntajeController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('p2ntaje.index', compact('puntajes'))
    ...
    {
        $puntaje = new Puntaje();
        return view('p2ntaje.create', compact('puntaje'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('p2ntajes.index')
    ...
    public function show($id)
    {
        ...
        return view('p2ntaje.show', compact('puntaje'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('p2ntaje.edit', compact('puntaje'));
    }
